...
import 'package:webpage_dev_console/models/helper.dart';
...
class _FlutterBrowserAppState extends State<FlutterBrowserApp> {
  bool isLoading = true;
  late HelperModel hm;
  Future _initialize() => Future(() async {
  ...
  Widget build(BuildContext context) {
    hm = Provider.of<HelperModel>(context, listen: true);
    print("Building");
    return MaterialApp(
      ...
      home: hm.restored == false ? _buildLoad() : Browser(),
      // initialRoute: '/',
      // routes: {
      //   '/': (context) => Browser(),
      // },
