...
//         return; // Not Allowed
// 	if (document.location.protocol != "https:" || !document.location.hostname.endsWith("tiktok.com"))
//         return; // Not Allowed
// 	if (document.location.protocol != "https:" || !document.location.hostname.endsWith("instagram.com"))
//         return; // Not Allowed
// 	if (document.location.protocol != "https:" || !document.location.hostname.endsWith("vk.com"))
//         return; // Not Allowed
// 	if (document.location.protocol != "https:" || !document.location.hostname.endsWith("dailymotion.com"))
//         return; // Not Allowed
...
*/
	for (var j = 0; j < 4; j++) {
	    for (var i = 0; ;) {
	        var o = FindFirstUrl(html, j == 4 ? ".m3u8" : j==3 ? ".3gp" : j == 2 ? ".mov" : j == 1 ? ".flv" : ".mp4", i);
	        if (!o || !o.start)
	            break;
	        i = o.start;
			
	        allUrlsList.push({ 'url': o.mp4, 'title': document.title, 'type': j==4?"m3u8":"video" });
	    }
	}
...
function isSupportedUrl( url) 
{
	...
	if (url.indexOf("data:image") != -1)  
	    return false;
    if ( (url.indexOf(".mp4") == -1) && (url.indexOf(".flv") == -1) && (url.indexOf(".mov") == -1) && (url.indexOf(".3gp") == -1))
        return false;
	return url;
}


function OnAddToVideoList(info) {
