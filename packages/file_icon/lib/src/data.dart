...
const iconSetMap = {
  'notPresent': SetiMeta(0XE80C, _purple),
  '.ipa': SetiMeta(_apple, _grey),
  ...
  '.gsm': SetiMeta(_audio, _purple),
  '.dct': SetiMeta(_audio, _purple),
  '.mid': SetiMeta(_audio, _purple),
  '.m4a': SetiMeta(_audio, _purple),
  '.mxp4': SetiMeta(_audio, _purple),
  '.iklax': SetiMeta(_audio, _purple),
  '.mmf': SetiMeta(_audio, _purple),
  '.mpc': SetiMeta(_audio, _purple),
